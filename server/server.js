...
const questions = [
  ...
  "あなたの年代は？",
  "インターネットの契約はどこですか？",
  "ポケットWi-Fi（モバイルルーター）を持ってますか？",
  "あなたのスマホの月額料金はいくらですか？",
  "全キャリア（au docomo SoftBank）を使えるポケットWi-Fiを使ってみたいですか？",
  "スマホ、パソコンやネットで困ってることありますか？",
  "スマホ、パソコンやネット困ってることを相談できる人がいますか？",
  "CBBSのキャンペーンのプレゼントは何がいいですか",
